% Programs 18e - Bifurcation Diagram for a Simple Bistable Neuromodule.
% Chapter 18 - Neural Networks.
% Copyright Springer 2014. Stephen Lynch.

% Bifurcation diagram for a two-neuron module. (See Figure 18.15).
% Vary bias b1.
clear all
format long;
...
plot(w(1:halfN),x1(1:halfN),'-','MarkerSize',1,'color','r');
