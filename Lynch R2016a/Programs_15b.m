% Programs 15b - Phase portraits for Hamiltonian systems with two degrees of freedom.
% Chapter 15 - Poincare Maps and Nonautonomous Systems in the Plane.
% Copyright Springer 2014. Stephen Lynch.

% Poincare surfaces of section (Fig. 15.5(e)-(f)).
...
% A 3-dimensional projection (Fig. 15.5(e)).
subplot(2,1,1)
fsize=15;
...
% A 2-dimensional projection (Fig. 15.5(f)).
